...
class MobileAddImagesPage extends StatefulWidget {
  const MobileAddImagesPage({Key? key}) : super(key: key);

  @override
  _MobileAddImagesPageState createState() => _MobileAddImagesPageState();
}

class _MobileAddImagesPageState extends State<MobileAddImagesPage> {
              ...
              child: SizedBox(
                  ...
                  child: TextField(
                      ...
                      decoration: const InputDecoration(
                          ...
                          suffixStyle: TextStyle(fontSize: 15, color: Colors.white),
              ...
              children: [
                ElevatedButton(
                    ...
                    child: Container(
                        ...
                        child: const Text('사진추가', style: TextStyle(fontSize: 15)))),
                ElevatedButton(
                    onPressed: () {
                      setState(() {
                        imagesList.clear();
                    ...
                    child: Container(
                        ...
                        alignment: Alignment.center,
                        decoration: const BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(20))),
                        child: const Text('전체삭제', style: TextStyle(fontSize: 15)))),
                ElevatedButton(
                    onPressed: () {
